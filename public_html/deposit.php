...
$sql0 = "SELECT * FROM accounts where active = true";
$sql1 = "ALTER TABLE accounts ADD active BOOLEAN  DEFAULT true";
...
<div class="container mx-5">
    <h2>Deposit funds</h2>
    <p>Please fill in your credentials to deposit funds.</p>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        ...
        <div class="form-group">
            <input type="submit" class="btn btn-primary" value="Deposit funds">
        </div>
    </form>
</div>
</body>
